...
result_loc = "paper2/Results/RAG/prompts_temporal.pkl"
...
#-----Cluster properties
loc = "paper2/Results/knn/knn_cluster_properties_fd_sp500_quantile_temporal.pkl"
...
#-------full embeddings
embedding_loc = "paper2/Data/embeddings/embeddings_fd_sp500_quantile_temporal.pkl"
...
labeled_embeddings_loc = "paper2/Data/embeddings/labeled_dataset_embeddings_fd_temporal.pkl"
...
#-----labeled dataset
dataset_loc = "paper1/Data/Labeled_Dataset/labeled_dataset.pkl"

with open(dataset_loc, "rb") as file:
    ld = pickle.load(file)

print(f"Keys of LD: {ld.keys()}")

labeled_dataset = ld["labeled_dataset_unique"]
ld_metadata = ld["metadata_unique"]
