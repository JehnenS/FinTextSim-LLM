...
save_loc = "paper2/Results/knn/knn_centroid_fd_sp500_quantile_temporal.pkl"

#---------------Define assigner
assigner = KNNTopicAssigner(
    embedding_loc = "paper2/Data/embeddings/embeddings_fd_sp500_quantile_temporal.pkl",
    labeled_dataset_loc = "paper2/Data/embeddings/labeled_dataset_embeddings_fd_temporal.pkl",
)
